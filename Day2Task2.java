...
public class Day2Task2 {
        ...
        public static boolean checkPossible(String input, String example) {
            ...
            for (int i = 0; i < games.length; i++) {
                ...
                for (int j = 0; j < partTemp.length; j++) {
                    ...
                    if(colorExist(gameMap,"red")) {
                        int tempMaxRed=gameMap.get("red");
                        if(tempMaxRed>redMaxCubes){
                            redMaxCubes=tempMaxRed;
                        }
                    }

                    if(colorExist(gameMap,"green")) {
                        int tempMaxGreen= gameMap.get("green");
                        if(tempMaxGreen>greenMaxCubes){
                            greenMaxCubes=tempMaxGreen;
                        }
                    }
                    if(colorExist(gameMap,"blue")) {
                        int tempMaxBlue=gameMap.get("blue");
                        if(tempMaxBlue>blueMaxCubes){
                            blueMaxCubes=tempMaxBlue;
                        }
                    }
                ...
                powerOfMinGames=redMaxCubes*greenMaxCubes*blueMaxCubes;
                System.out.println(powerOfMinGames+"................POWER............");
                sumOfPowers+=powerOfMinGames;
                System.out.println(sumOfPowers+" sum of Powers");
        ...
        public static boolean colorExist(Map<String, Integer> map,String colors){
            boolean exist=false;
            for (Map.Entry<String, Integer> e : map.entrySet()) {
                exist=false;
                if(e.getKey().equals(colors) ){
                    exist= true;
                    break;
                }
            }
            System.out.println(exist+";"+colors);
            return exist;
        }
        public static void checkColorsExist(){

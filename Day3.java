...
//        String input="................458...689.556..3............197......582........720.........................515..352..286.........670.741.....895.626.......\n" +
...
//                     ".664.598..";
        ...
        List<String> engineSchematic = new ArrayList<>(convertStringToArrayList(input));
        ...
        for (int i = 0; i <engineSchematic.size(); i++) {
            ...
            boolean endOfDigit = true;
            if (Character.isDigit(engineSchematic.get(i).charAt(0))) {
                temp += Integer.parseInt(String.valueOf(engineSchematic.get(i).charAt(0)));
                digitChar = true;

                firstIdx = 0;
                System.out.println(firstIdx + " first Idx");
                endOfDigit = false;

                System.out.println((engineSchematic.get(i).charAt(0)));
                countDigits++;
            }
            for (int j = 1; j < engineSchematic.get(i).length(); j++) {
                current = engineSchematic.get(i).charAt(j);
                previous = engineSchematic.get(i).charAt(j - 1);

                if (Character.isDigit(current)) {
                    int currentIntValue = Integer.parseInt(String.valueOf(engineSchematic.get(i).charAt(j)));
                    digitChar = true;
                    if (endOfDigit) {
                        firstIdx = j;
                        System.out.println(firstIdx + " first Idx");
                    ...
                    System.out.println((engineSchematic.get(i).charAt(j)));
                    countDigits++;
                    if (Character.isDigit(previous)) {
                        temp = temp * 10 + currentIntValue;
                    } else {
                        temp += currentIntValue;
                    }
                } else {
                    if (digitChar) {
                        if (nearSymbol(engineSchematic, i, firstIdx, countDigits)) {
                            sum += temp;
                        }
                        endOfDigit = true;
                        temp = 0;
    ...
    private static boolean nearSymbol(List<String> engineSchematic, int i, int firstIdx, int countDigits) {
        boolean nearToSymbol = false;
        int engSize = engineSchematic.size();
...
//            ) {
        ...
        System.out.println(engineSchematic.get(i).charAt(firstIdx) + " digit of first index");
        return nearToSymbol;
    }
    public static List<String> convertStringToArrayList(String input){
        String[]inputArray=input.split("\\n");
        List<String> rowList = new ArrayList<>(Arrays.asList(inputArray));

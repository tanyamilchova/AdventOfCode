...
//                        "Card 6: 31 18 13 56 72 | 74 77 10 23 35 67 36 11";
        ...
        for (int i = 0; i < arrayInput.length; i++) {
            ...
            List<String> cardParts = Collections.singletonList(cardDevision[0].trim());
            String[] devidedValues = cardDevision[1].trim().split("\\|");
            cardNums.add(cardDevision[0].trim());
            winingParts.add(devidedValues[0].trim());
            scratchedParts.add(devidedValues[1].trim());
        }
//        System.out.println(cardNums);
//        System.out.println(winingParts);
//        System.out.println(scratchedParts);
     ...
     List<List<Integer>>intScratchedList=new ArrayList<>();
        ...
        System.out.println(intWinList);
        System.out.println(intScratchedList);
        System.out.println(checkForWiningNums(intWinList,intScratchedList));



    }
    public static int checkForWiningNums(List<List<Integer>>intWinList,List<List<Integer>>intScratchedList){
       int sum=0;
